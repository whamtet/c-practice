...
c_practice.core.p = (function p(p1__6377_SHARP_){return cljs.core.println.call(null,cljs.core.pr_str.call(null,p1__6377_SHARP_));
});
c_practice.core.t = (function t(){return c_practice.core.p.call(null,cljs.core.deref.call(null,c_practice.core.completed));
});
c_practice.core.data = (function (){var iter__4286__auto__ = (function iter__6378(s__6379){return (new cljs.core.LazySeq(null,(function (){var s__6379__$1 = s__6379;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__6379__$1);if(temp__4126__auto__)
{var s__6379__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__6379__$2))
{var c__4284__auto__ = cljs.core.chunk_first.call(null,s__6379__$2);var size__4285__auto__ = cljs.core.count.call(null,c__4284__auto__);var b__6381 = cljs.core.chunk_buffer.call(null,size__4285__auto__);if((function (){var i__6380 = (0);while(true){
if((i__6380 < size__4285__auto__))
{var line = cljs.core._nth.call(null,c__4284__auto__,i__6380);cljs.core.chunk_append.call(null,b__6381,line.trim().split(","));
{
var G__6382 = (i__6380 + (1));
i__6380 = G__6382;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__6381),iter__6378.call(null,cljs.core.chunk_rest.call(null,s__6379__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__6381),null);
}
} else
{var line = cljs.core.first.call(null,s__6379__$2);return cljs.core.cons.call(null,line.trim().split(","),iter__6378.call(null,cljs.core.rest.call(null,s__6379__$2)));
}
} else
{return null;
}
...
c_practice.core.naive_shuffler = (function (){var x = cljs.core.shuffle.call(null,cljs.core.range.call(null,(802)));return cljs.core.zipmap.call(null,x,cljs.core.drop.call(null,(1),cljs.core.cycle.call(null,x)));
})();
c_practice.core.smart_shuffler = (function smart_shuffler(i){if(cljs.core._EQ_.call(null,(802),cljs.core.count.call(null,cljs.core.deref.call(null,c_practice.core.completed))))
{return (0);
} else
{var j = c_practice.core.naive_shuffler.call(null,i);while(true){
if(cljs.core.truth_(cljs.core.deref.call(null,c_practice.core.completed).call(null,j)))
{{
var G__6383 = c_practice.core.naive_shuffler.call(null,j);
j = G__6383;
continue;
}
} else
...
return cljs.core.swap_BANG_.call(null,c_practice.core.i,c_practice.core.smart_shuffler);
});
...
c_practice.core.proceed = (function proceed(p1__6384_SHARP_){var value = (cljs.core.truth_(p1__6384_SHARP_)?p1__6384_SHARP_.target.value:cljs.core.deref.call(null,c_practice.core.proceed_text));var id = (cljs.core.truth_(cljs.core.deref.call(null,c_practice.core.random_mode_QMARK_))?c_practice.core.smart_shuffler.call(null,cljs.core.deref.call(null,c_practice.core.i)):cljs.core.deref.call(null,c_practice.core.i));if(cljs.core._EQ_.call(null,value,cljs.core.first.call(null,cljs.core.nth.call(null,c_practice.core.data,id))))
...
return (function (p1__6385_SHARP_){if(cljs.core.truth_(cljs.core.deref.call(null,c_practice.core.auto_proceed_QMARK_)))
{return c_practice.core.proceed.call(null,p1__6385_SHARP_);
} else
{var value = p1__6385_SHARP_.target.value;return cljs.core.reset_BANG_.call(null,c_practice.core.proceed_text,value);
}
});})(id,s))
...
return (function (p1__6386_SHARP_){return cljs.core.reset_BANG_.call(null,c_practice.core.show_char_QMARK_,p1__6386_SHARP_.target.checked);
});})(id,s))
...
return (function (p1__6387_SHARP_){return cljs.core.reset_BANG_.call(null,c_practice.core.auto_proceed_QMARK_,p1__6387_SHARP_.target.checked);
});})(id,s))
...
return (function (p1__6388_SHARP_){var checked_QMARK_ = p1__6388_SHARP_.target.checked;cljs.core.reset_BANG_.call(null,c_practice.core.random_mode_QMARK_,checked_QMARK_);
...
return (function (p1__6389_SHARP_){return cljs.core.reset_BANG_.call(null,c_practice.core.text,p1__6389_SHARP_.target.value);
});})(id,s))
], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"value","value",305978217),"Go",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (id,s){
