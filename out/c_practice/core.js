...
c_practice.core.p = (function p(p1__5905_SHARP_){return cljs.core.println.call(null,cljs.core.pr_str.call(null,p1__5905_SHARP_));
});
c_practice.core.t = (function t(){return c_practice.core.p.call(null,cljs.core.deref.call(null,c_practice.core.completed));
});
c_practice.core.data = (function (){var iter__4286__auto__ = (function iter__5906(s__5907){return (new cljs.core.LazySeq(null,(function (){var s__5907__$1 = s__5907;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__5907__$1);if(temp__4126__auto__)
{var s__5907__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__5907__$2))
{var c__4284__auto__ = cljs.core.chunk_first.call(null,s__5907__$2);var size__4285__auto__ = cljs.core.count.call(null,c__4284__auto__);var b__5909 = cljs.core.chunk_buffer.call(null,size__4285__auto__);if((function (){var i__5908 = (0);while(true){
if((i__5908 < size__4285__auto__))
{var line = cljs.core._nth.call(null,c__4284__auto__,i__5908);cljs.core.chunk_append.call(null,b__5909,line.trim().split(","));
{
var G__5910 = (i__5908 + (1));
i__5908 = G__5910;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__5909),iter__5906.call(null,cljs.core.chunk_rest.call(null,s__5907__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__5909),null);
}
} else
{var line = cljs.core.first.call(null,s__5907__$2);return cljs.core.cons.call(null,line.trim().split(","),iter__5906.call(null,cljs.core.rest.call(null,s__5907__$2)));
}
} else
{return null;
}
...
c_practice.core.smart_shuffle_forward = (function smart_shuffle_forward(p1__5912_SHARP_){return c_practice.core.smart_shuffler.call(null,c_practice.core.shuffle_forward,p1__5912_SHARP_);
});
c_practice.core.smart_shuffle_backward = (function smart_shuffle_backward(p1__5913_SHARP_){return c_practice.core.smart_shuffler.call(null,c_practice.core.shuffle_backward,p1__5913_SHARP_);
});
...
c_practice.core.proceed = (function proceed(p1__5914_SHARP_){var value = (cljs.core.truth_(p1__5914_SHARP_)?p1__5914_SHARP_.target.value:cljs.core.deref.call(null,c_practice.core.proceed_text));var id = cljs.core.deref.call(null,c_practice.core.i);if(cljs.core._EQ_.call(null,value,cljs.core.first.call(null,cljs.core.nth.call(null,c_practice.core.data,id))))
...
return (function (p1__5915_SHARP_){if(cljs.core.truth_(cljs.core.deref.call(null,c_practice.core.auto_proceed_QMARK_)))
{return c_practice.core.proceed.call(null,p1__5915_SHARP_);
} else
{var value = p1__5915_SHARP_.target.value;return cljs.core.reset_BANG_.call(null,c_practice.core.proceed_text,value);
}
});})(id,s))
...
return (function (p1__5916_SHARP_){return cljs.core.reset_BANG_.call(null,c_practice.core.show_char_QMARK_,p1__5916_SHARP_.target.checked);
});})(id,s))
...
return (function (p1__5917_SHARP_){return cljs.core.reset_BANG_.call(null,c_practice.core.auto_proceed_QMARK_,p1__5917_SHARP_.target.checked);
});})(id,s))
...
return (function (p1__5918_SHARP_){var checked_QMARK_ = p1__5918_SHARP_.target.checked;return cljs.core.reset_BANG_.call(null,c_practice.core.random_mode_QMARK_,checked_QMARK_);
});})(id,s))
...
return (function (p1__5919_SHARP_){return cljs.core.reset_BANG_.call(null,c_practice.core.text,p1__5919_SHARP_.target.value);
});})(id,s))
], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"value","value",305978217),"Go",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (id,s){
