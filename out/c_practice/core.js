...
c_practice.core.p = (function p(p1__5238_SHARP_){return cljs.core.println.call(null,cljs.core.pr_str.call(null,p1__5238_SHARP_));
});
c_practice.core.data = (function (){var iter__4286__auto__ = (function iter__5239(s__5240){return (new cljs.core.LazySeq(null,(function (){var s__5240__$1 = s__5240;while(true){
...
{var c__4284__auto__ = cljs.core.chunk_first.call(null,s__5240__$2);var size__4285__auto__ = cljs.core.count.call(null,c__4284__auto__);var b__5242 = cljs.core.chunk_buffer.call(null,size__4285__auto__);if((function (){var i__5241 = (0);while(true){
if((i__5241 < size__4285__auto__))
{var line = cljs.core._nth.call(null,c__4284__auto__,i__5241);cljs.core.chunk_append.call(null,b__5242,line.trim().split(","));
{
...
{var line = cljs.core.first.call(null,s__5240__$2);return cljs.core.cons.call(null,line.trim().split(","),iter__5239.call(null,cljs.core.rest.call(null,s__5240__$2)));
}
} else
{return null;
}
...
c_practice.core.proceed = (function proceed(p1__5244_SHARP_){var value = (cljs.core.truth_(p1__5244_SHARP_)?p1__5244_SHARP_.target.value:cljs.core.deref.call(null,c_practice.core.proceed_text));var id = (cljs.core.truth_(cljs.core.deref.call(null,c_practice.core.random_mode_QMARK_))?c_practice.core.shuffler.call(null,cljs.core.deref.call(null,c_practice.core.i)):cljs.core.deref.call(null,c_practice.core.i));if(cljs.core._EQ_.call(null,value,cljs.core.first.call(null,cljs.core.nth.call(null,c_practice.core.data,id))))
...
], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),((function (id,s){
...
return (function (p1__5245_SHARP_){if(cljs.core.truth_(cljs.core.deref.call(null,c_practice.core.auto_proceed_QMARK_)))
{return c_practice.core.proceed.call(null,p1__5245_SHARP_);
} else
{var value = p1__5245_SHARP_.target.value;return cljs.core.reset_BANG_.call(null,c_practice.core.proceed_text,value);
}
});})(id,s))
...
return (function (p1__5246_SHARP_){return cljs.core.reset_BANG_.call(null,c_practice.core.show_char_QMARK_,p1__5246_SHARP_.target.checked);
});})(id,s))
...
return (function (p1__5247_SHARP_){return cljs.core.reset_BANG_.call(null,c_practice.core.auto_proceed_QMARK_,p1__5247_SHARP_.target.checked);
});})(id,s))
...
return (function (p1__5248_SHARP_){var checked_QMARK_ = p1__5248_SHARP_.target.checked;cljs.core.reset_BANG_.call(null,c_practice.core.random_mode_QMARK_,checked_QMARK_);
...
return (function (p1__5249_SHARP_){return cljs.core.reset_BANG_.call(null,c_practice.core.text,p1__5249_SHARP_.target.value);
});})(id,s))
], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"value","value",305978217),"Go",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (id,s){
