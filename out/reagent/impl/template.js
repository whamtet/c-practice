...
{return (function() { 
var G__9336__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
var args = cljs.core.seq(arglist__9337);
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__3553__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__3553__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__9339 = res;(G__9339[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__9339;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__9340){var vec__9342 = p__9340;var id = cljs.core.nth.call(null,vec__9342,(0),null);var class$ = cljs.core.nth.call(null,vec__9342,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_9343 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_9343 === "key")))
{(o[pname_9343] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__9346 = jsprops;(G__9346["defaultValue"] = value);
(G__9346["value"] = null);
(G__9346["onChange"] = ((function (G__9346,on_change,value){
return (function (p1__9344_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__9344_SHARP_);
});})(G__9346,on_change,value))
);
return G__9346;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__9352 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__9352,(0),null);var id = cljs.core.nth.call(null,vec__9352,(1),null);var class$ = cljs.core.nth.call(null,vec__9352,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3553__auto__ = id;if(cljs.core.truth_(or__3553__auto__))
{return or__3553__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__9354 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__9354,(0),null);var id_class = cljs.core.nth.call(null,vec__9354,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj9358 = {};(obj9358[reagent.impl.util.cljs_argv] = v);
(obj9358[reagent.impl.util.cljs_level] = level);
return obj9358;
})();var k_9359 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__9360 = (((k_9359 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_9359);if((k_SINGLEQUOTE__9360 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__9360);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4409__auto___9361 = a.length;var i_9362 = (0);while(true){
if((i_9362 < n__4409__auto___9361))
{(a[i_9362] = reagent.impl.template.as_component.call(null,(a[i_9362]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4409__auto___9364 = a.length;var i_9365 = (0);while(true){
if((i_9365 < n__4409__auto___9364))
{if((i_9365 >= first_child))
{(a[i_9365] = reagent.impl.template.as_component.call(null,(a[i_9365]),level));
} else
{}
{
var G__9366 = (i_9365 + (1));
i_9365 = G__9366;
continue;
}
} else
