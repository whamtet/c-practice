...
{return (function() { 
var G__6359__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__6362 = res;(G__6362[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__6362;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__6363){var vec__6365 = p__6363;var id = cljs.core.nth.call(null,vec__6365,(0),null);var class$ = cljs.core.nth.call(null,vec__6365,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_6366 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_6366 === "key")))
{(o[pname_6366] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__6369 = jsprops;(G__6369["defaultValue"] = value);
(G__6369["value"] = null);
(G__6369["onChange"] = ((function (G__6369,on_change,value){
return (function (p1__6367_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__6367_SHARP_);
});})(G__6369,on_change,value))
);
return G__6369;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__6371 = spec;(G__6371["componentDidUpdate"] = ((function (G__6371){
return (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
});})(G__6371))
);
(G__6371["componentWillUnmount"] = ((function (G__6371){
...
return (function (p1__6372_SHARP_,p2__6373_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__6372_SHARP_,p2__6373_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__6375 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__6375,(0),null);var id = cljs.core.nth.call(null,vec__6375,(1),null);var class$ = cljs.core.nth.call(null,vec__6375,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__6377 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__6377,(0),null);var id_class = cljs.core.nth.call(null,vec__6377,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj6381 = {};(obj6381[reagent.impl.util.cljs_argv] = v);
(obj6381[reagent.impl.util.cljs_level] = level);
return obj6381;
})();var k_6382 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__6383 = (((k_6382 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_6382);if((k_SINGLEQUOTE__6383 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__6383);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4409__auto___6384 = a.length;var i_6385 = (0);while(true){
if((i_6385 < n__4409__auto___6384))
{(a[i_6385] = reagent.impl.template.as_component.call(null,(a[i_6385]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4409__auto___6387 = a.length;var i_6388 = (0);while(true){
if((i_6388 < n__4409__auto___6387))
{if((i_6388 >= first_child))
{(a[i_6388] = reagent.impl.template.as_component.call(null,(a[i_6388]),level));
} else
{}
{
