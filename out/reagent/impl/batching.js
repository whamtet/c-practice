...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__3553__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__3553__auto__))
{return or__3553__auto__;
} else
{var or__3553__auto____$1 = w.webkitRequestAnimationFrame;if(cljs.core.truth_(or__3553__auto____$1))
{return or__3553__auto____$1;
} else
{var or__3553__auto____$2 = w.mozRequestAnimationFrame;if(cljs.core.truth_(or__3553__auto____$2))
{return or__3553__auto____$2;
} else
{var or__3553__auto____$3 = w.msRequestAnimationFrame;if(cljs.core.truth_(or__3553__auto____$3))
...
var n__4409__auto__ = a.length;var i = (0);while(true){
if((i < n__4409__auto__))
{var C_6342 = (a[i]);if(cljs.core.truth_(C_6342.cljsIsDirty))
{C_6342.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4120__auto__,writer__4121__auto__,opt__4122__auto__){return cljs.core._write.call(null,writer__4121__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__3541__auto__ = !((C == null));if(and__3541__auto__)
{var and__3541__auto____$1 = (C["props"]);if(cljs.core.truth_(and__3541__auto____$1))
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_6344 = C.cljsRatom;if(!((ratom_6344 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_6344);
} else
{}
