...
goog.require('goog.Timer');
goog.require('tailrecursion.cljson');
alandipert.storage_atom.IStorageBackend = (function (){var obj5813 = {};return obj5813;
})();
alandipert.storage_atom._get = (function _get(this$,not_found){if((function (){var and__3549__auto__ = this$;if(and__3549__auto__)
...
{var x__4188__auto__ = (((this$ == null))?null:this$);return (function (){var or__3561__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__4188__auto__)]);if(or__3561__auto__)
{return or__3561__auto__;
} else
{var or__3561__auto____$1 = (alandipert.storage_atom._get["_"]);if(or__3561__auto____$1)
...
alandipert.storage_atom._commit_BANG_ = (function _commit_BANG_(this$,value){if((function (){var and__3549__auto__ = this$;if(and__3549__auto__)
...
{var x__4188__auto__ = (((this$ == null))?null:this$);return (function (){var or__3561__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__4188__auto__)]);if(or__3561__auto__)
{return or__3561__auto__;
} else
{var or__3561__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);if(or__3561__auto____$1)
{return or__3561__auto____$1;
} else
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__4128__auto__,writer__4129__auto__,opt__4130__auto__){return cljs.core._write.call(null,writer__4129__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__5819 = atom;cljs.core.add_watch.call(null,G__5819,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__5819,existing,debounce){
return (function (p1__5816_SHARP_,p2__5817_SHARP_,p3__5814_SHARP_,p4__5815_SHARP_){if(cljs.core.truth_((function (){var and__3549__auto__ = alandipert.storage_atom._STAR_watch_active_STAR_;if(cljs.core.truth_(and__3549__auto__))
{return cljs.core.not_EQ_.call(null,p3__5814_SHARP_,p4__5815_SHARP_);
} else
{return and__3549__auto__;
}
})()))
{return debounce.call(null,((function (G__5819,existing,debounce){
return (function (){return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__5815_SHARP_);
});})(G__5819,existing,debounce))
,(function (){var or__3561__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;if(cljs.core.truth_(or__3561__auto__))
{return or__3561__auto__;
} else
...
{var value = tailrecursion.cljson.cljson__GT_clj.call(null,e.newValue);var _STAR_watch_active_STAR_5821 = alandipert.storage_atom._STAR_watch_active_STAR_;try{alandipert.storage_atom._STAR_watch_active_STAR_ = false;
return cljs.core.reset_BANG_.call(null,atom,value);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_5821;
}} else
{return null;
}
} else
...
alandipert.storage_atom.link_storage = (function link_storage(atom,k){return window.addEventListener("storage",(function (p1__5822_SHARP_){return alandipert.storage_atom.maybe_load_backend.call(null,atom,k,p1__5822_SHARP_);
}));
});
